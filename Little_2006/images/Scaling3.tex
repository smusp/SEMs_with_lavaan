...
\path [variance] (POS7.120) edge ["$\upphi_{7,11}$", above, bend left = 110, looseness = 3] (POS7.60);
\path [variance] (NEG7.120) edge ["$\upphi_{7,22}$", above, bend left = 110, looseness = 3] (NEG7.60);
...
%% Intercepts
\path [regression, black!30] (M7) edge ["$\uptau_{1}$"] (pos71.south east);
\path [regression, black!30] (M7) edge ["$\uptau_{2}$"] (pos72.south east);
\path [regression, black!30] (M7) edge ["$\uptau_{3}$"] (pos73);

\path [regression, black!30] (M7) edge ["$\uptau_{4}$"] (neg71);
\path [regression, black!30] (M7) edge ["$\uptau_{5}$"] (neg72.south west);
\path [regression, black!30] (M7) edge ["$\uptau_{6}$"] (neg73.south west);
...
%% Intercepts
\path [regression, black!30] (M8) edge ["$\uptau_{1}$"] (pos81.south east);
\path [regression, black!30] (M8) edge ["$\uptau_{2}$"] (pos82.south east);
\path [regression, black!30] (M8) edge ["$\uptau_{3}$"] (pos83);

\path [regression, black!30] (M8) edge ["$\uptau_{4}$"] (neg81);
\path [regression, black!30] (M8) edge ["$\uptau_{5}$"] (neg82.south west);
\path [regression, black!30] (M8) edge ["$\uptau_{6}$"] (neg83.south west);
