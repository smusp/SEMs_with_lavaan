...
\path [regression] (e76) edge ["$\uptheta_{7,6}$", pos = 0] (neg73.north east);
...
%% Intercepts
\path [regression, black!30] (M7.175) edge ["$\uptau_{1}$"] (pos71.south east);
...
\path [regression, black!30] (M7.5) edge ["$\uptau_{6}$"] (neg73.south west);
...
%% Intercepts
\path [regression, black!30] (M8.175) edge ["$\uptau_{1}$"] (pos81.south east);
...
\path [regression, black!30] (M8.5) edge ["$\uptau_{6}$"] (neg83.south west);
