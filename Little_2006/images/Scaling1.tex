...
\path [variance] (POS7.120) edge ["$\upphi_{7,11}\!=\!1$", above, outer sep = 1pt, bend left = 110, looseness = 3] (POS7.60);
\path [variance] (NEG7.120) edge ["$\upphi_{7,22}\!=\!1$", above, outer sep = 1pt, bend left = 110, looseness = 3] (NEG7.60);
