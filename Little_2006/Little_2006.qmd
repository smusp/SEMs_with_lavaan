---
title: "Scaling and identifying latent variables"
...
This  shows how to set constraints for different methods of identification and scaling in latent variable models, and, though invariance is not a topic of discussion, the example shows how to set constraints for strong metric invariance in a two-group model. Also, the example shows how to use summary data (correlations, standard deviations, and means) in a two-group model.
...
![](images/Scaling.svg){fig-align="center"}
...
![](images/Scaling2.svg){fig-align="center"}
...
![](images/Scaling3.svg){fig-align="center"}
