...
\input{../Jose_2013/tex/SEMstyles.tex}
...
\node [manifest, very thick, fill = blue!20] (X) {\large{X}};
\node [manifest, very thick, fill = blue!20] (Y) [right = 5cm of X] {\large{Y}};
\node [manifest, very thick, fill = blue!20] (M) [above = 3cm of $(X.north) !0.45! (Y.north)$] {\large{M}};
