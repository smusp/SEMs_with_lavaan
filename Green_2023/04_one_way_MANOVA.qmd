...
By way of completeness, get the error SSCP matrices. (Thompson, Liu & Green (TLG) state that, "the error SSCP matrices were perfectly reproduced by multiplying the variances and covariances in the SEM output by the total sample size" p. 398).
