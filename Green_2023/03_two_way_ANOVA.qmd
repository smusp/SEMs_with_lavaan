...
On page 394, Thompson, Lie & Green give Cramer's V for the Gender X Coping Strategy crosstabulation. As far as I know, Cramer's V is not available in base R, but **DescTools** is one of possibly many packages that has a function for Cramer's V.
